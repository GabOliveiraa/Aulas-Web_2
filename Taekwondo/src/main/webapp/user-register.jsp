    ...
    <div class="col-lg-6 offset-lg-3 col-sm-12">
      ...
      <form action="${pageContext.request.contextPath}/studentRegisterServlet" method="post" id="form1">
        ...
        <div class="mb-2">
          ...
          <input type="text" name="name" id="name" class="form-control" minlength="3" maxlength="80" required>
          <span id="0"></span>
        </div>
        ...
        <div class="mb-2">
          <label for="belt">Faixa atual*</label>
          <select class="form-select" name="belt" id="belt" required>
            <option value="" selected>Selecione</option>
